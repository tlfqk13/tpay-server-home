...
public enum PushCategoryType {
    ...
    CASE_FIVE("5", "ktp://notification/detail", "\uD83D\uDC4F처음 환급이 완료되었습니다! T.POINT가 2주 뒤에 적립될 예정이에요\uD83D\uDC4F", "T.POINT가 무엇인지와 유효기간에 대해 알려드릴게요."),
    ...
    CASE_EIGHT("8", "RequestWithdrawal", " 점주님, 소멸 예정인 T.POINT가 있어요‼️", "한달 이내로 소멸예정인 T.POINT를 출금해주세요."),
    CASE_NINE("9", "ktp://sales/statistics", "과연 이번달에는 지난달보다 매출이 높아졌을까요?\uD83E\uDD14", "이번달의 매출과 환급건수를 지난달과 비교해보세요!"),
    CASE_TEN("10", "ktp://sales/statistics", "과연 올해에는 작년보다 매출이 높아졌을까요?\uD83E\uDD14", "올해의 매출과 환급건수를 작년과 비교해보세요!"),
    CASE_ELEVEN("11", "ktp://vat/report", " 점주님, 부가세 신고기간이에요!\uD83D\uDE00", "지금 부가세 신고자료를 다운로드 받아보세요."),
    CASE_TWELVE("12", "ktp://notification", "\uD83D\uDC49내일은 환급수수료가 이체되는 날이에요", "CMS 출금예정 금액: "),
