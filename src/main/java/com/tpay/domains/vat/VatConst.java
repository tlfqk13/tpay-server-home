package com.tpay.domains.vat;

import lombok.Getter;
import lombok.RequiredArgsConstructor;

import static com.tpay.domains.vat.VatConst.VatConstType.CHAR;
import static com.tpay.domains.vat.VatConst.VatConstType.NUMERIC;

@Getter
@RequiredArgsConstructor
public enum VatConst {
    ...
    // HEAD
    COMPANY_NAME(CHAR, 18, 60), // 법인명(상호)
    ...
    VatConst(VatConstType constType, int start, int len) {
