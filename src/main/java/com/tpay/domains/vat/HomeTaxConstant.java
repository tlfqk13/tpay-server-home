...
import static com.tpay.domains.vat.HomeTaxConstant.VatConstType.CHAR;
import static com.tpay.domains.vat.HomeTaxConstant.VatConstType.NUMERIC;
...
public enum HomeTaxConstant {
    ...
    TAX_REFUND_AMOUNT(NUMERIC, 104, 15), // 즉시환급액
